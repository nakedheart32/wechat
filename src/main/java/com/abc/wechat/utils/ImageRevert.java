...
public class ImageRevert {
     ...
     * @return
     */
    private  Object[] getXor(File file) {
        Object[] xor = null;
        if (file != null) {
     ...
     * @return
     */
    private  Object[] getXor(byte[] bytes) {
    ...
    private static void getAllFileType() {
        ...
        FILE_TYPE_MAP.put("89504e470d0a1a0a0000", "jpg"); //PNG (png)
        FILE_TYPE_MAP.put("47494638396126026f01", "jpg"); //GIF (gif)
        FILE_TYPE_MAP.put("49492a00227105008037", "jpg"); //TIFF (tif)
        FILE_TYPE_MAP.put("424d228c010000000000", "jpg"); //16色位图(bmp)
        FILE_TYPE_MAP.put("424d8240090000000000", "jpg"); //24位位图(bmp)
        FILE_TYPE_MAP.put("424d8e1b030000000000", "jpg"); //256色位图(bmp)
